...
G4VPhysicalVolume *DetectorConstruction::Construct(){
    ...
    fLogicDetector= new G4LogicalVolume(solidDetector, detMat, "logicDetector");
    G4VPhysicalVolume *physDetector = new G4PVPlacement(0, G4ThreeVector(0., 0. , 10.5 * cm), fLogicDetector, "physDetector", logicWorld, false, checkOverlaps);
